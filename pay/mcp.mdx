...
| `pay_with_split(...)` | Retired compatibility tool; returns `legacy_split_route_retired` and moves no funds. |
...
| `quote_cost(...)` | Preview canonical gross-inclusive AIFP-1 economics (no payment). |
