...
<Info>
Most merchants should start with the [self-serve dashboard](/charge/dashboard)
instead — sign up, create a service, and verify signed receipts, with no
bridge to run. This page covers the advanced bridge / marketplace-registry
path, for providers who also want their API listed in the AiFinPay registry.
</Info>
