...
<Note>
  There is no token to acquire to use AiFinPay, and no internal credit to earn.
  mSECCO was retired on 2026-08-06: crediting it required an extra chain call on every payment, and it was never minted — total supply is zero. Agents pay in real assets and nothing else changes hands.
</Note>
...
<CardGroup cols={2}>
  <Card title="Python SDK" icon="python" href="/pay/python">
    ...
    canonical gross-inclusive settlement and fail-closed route verification.
  </Card>
