...
<Note>
  There is no AiFinPay token, and no internal credit either. mSECCO was retired on 2026-08-06: crediting it required an extra chain call on every payment, and it was never minted — total supply is zero.
</Note>
